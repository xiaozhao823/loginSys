<template>
  <div class="account">
    ...
    <div class="content">
      ...
      <div class="contentText">Your information is complete,we will contact you later, thank you!</div>
      <div class="botText">will closethis page within 3seconds......</div>
      <!-- <div class="leftContent">
        <img src="../assets/signBack.jpg" alt="">
      </div>
      <div class="rightContent">
        <div class="rightText">Congratulation!<br> Your account has been created!</div>
